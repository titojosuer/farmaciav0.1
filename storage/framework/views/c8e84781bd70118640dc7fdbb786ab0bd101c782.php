...
<head>
    ...
    <title>Login | CoreUI | <?php echo e(config('app.name')); ?></title>
                ...
                <div class="card p-4">
                    <div class="card-body">
                        <form method="post" action="<?php echo e(url('/login')); ?>">
                            <?php echo csrf_field(); ?>
                            <h1>Iniciar</h1>
                            <p class="text-muted">Entrar en tu cuenta</p>
...
<?php /**PATH /home/titojosuer/Descargas/far/protected-lowlands-54743/resources/views/auth/login.blade.php ENDPATH**/ ?>