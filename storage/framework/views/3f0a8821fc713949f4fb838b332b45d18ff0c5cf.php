<?php $__env->startSection('content'); ?>
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
         <a href="<?php echo url('pedidos'); ?>">PEDIDOS</a>
      </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <?php echo Form::open(['route' => 'pedidos.store','method'=>'POST','autocomplete'=>'off']); ?>


                            <div class="card-body">

                              <?php echo $__env->make('pedidos.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


                            </div>
                            <div class="card-footer text-muted">
                                <button type="submit" id="guardar" class="btn btn-primary mr-2 float-right">Registrar Compra</button>
                                <a href="<?php echo e(url('pedidos')); ?>" class="btn btn-secondary">Cancel</a>
                            </div>
                            <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/titojosuer/Descargas/far/protected-lowlands-54743/resources/views/pedidos/create.blade.php ENDPATH**/ ?>